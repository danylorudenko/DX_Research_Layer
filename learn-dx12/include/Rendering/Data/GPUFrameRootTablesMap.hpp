...
public:
    ...
    using StateAndResource = std::pair<D3D12_RESOURCE_STATES, GPUResourceFrameSet*>;
    
    GPUFrameRootTablesMap();
    GPUFrameRootTablesMap(Microsoft::WRL::ComPtr<ID3D12DescriptorHeap>& parentHeap, std::vector<GPUResourceFrameSetDescriptor> const& map, std::vector<StateAndResource> const& describedResources);
    GPUFrameRootTablesMap(Microsoft::WRL::ComPtr<ID3D12DescriptorHeap>& parentHeap, std::vector<GPUResourceFrameSetDescriptor>&& map, std::vector<StateAndResource>&& describedResources);
    ...
    GPUResourceFrameSet* DescribedResource(int resourceIndex);
...
private:
    ...
    std::vector<GPUResourceFrameSetDescriptor> descriptorTable_;
