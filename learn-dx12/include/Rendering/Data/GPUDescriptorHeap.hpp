...
public:
    ...
    GPUResourceFrameSetDescriptor AllocRtvLinear(GPUResourceFrameSet* resources,
                                              D3D12_RENDER_TARGET_VIEW_DESC* viewDesc,
                                              D3D12_RESOURCE_STATES state = D3D12_RESOURCE_STATE_COMMON,
                                              char const* semantics = "default",
                                              int frameCount = 1U);

    GPUResourceFrameSetDescriptor AllocDsvLinear(GPUResourceFrameSet* resources,
                                              D3D12_DEPTH_STENCIL_VIEW_DESC* viewDesc,
                                              D3D12_RESOURCE_STATES state = D3D12_RESOURCE_STATE_COMMON,
                                              char const* semantics = "default",
                                              int frameCount = 1U);

    GPUResourceFrameSetDescriptor AllocCbvLinear(GPUResourceFrameSet* resources,
                                              D3D12_CONSTANT_BUFFER_VIEW_DESC* viewDesc,
                                              D3D12_RESOURCE_STATES state = D3D12_RESOURCE_STATE_COMMON,
                                              char const* semantics = "default",
                                              int frameCount = 1U);

    GPUResourceFrameSetDescriptor AllocSrvLinear(GPUResourceFrameSet* resources,
                                              D3D12_SHADER_RESOURCE_VIEW_DESC* viewDesc,
                                              D3D12_RESOURCE_STATES state = D3D12_RESOURCE_STATE_COMMON,
                                              char const* semantics = "default",
                                              int frameCount = 1U);

    GPUResourceFrameSetDescriptor AllocUavLinear(GPUResourceFrameSet* resources,
